...
export const TRANSLATIONS = {
    ru: {
        ...
        cityBreak: " Город",
        businessTrip: " Работа",
        outdoorAdventure: " Приключение",
        beachEscape: " Пляж",
        winterTrip: " Зима",
        familyTrip: " Семья",
        romanticGetaway: " Романтика",
        activitiesLabel: "Акценты поездки:",
        accommodationLabel: "Где живёте:",
        laundryLabel: "Стирка:",
        packingStyleLabel: "Стиль сборов:",
        tripNoteLabel: "Что ещё учесть:",
        tripNotePlaceholder: "Например: едем в горы, будет ужин в ресторане и хочу уместиться в ручную кладь",
        hotel: " Отель",
        apartment: " Апартаменты",
        hostel: " Хостел",
        camping: " Кемпинг",
        noLaundry: " Без стирки",
        limitedLaundry: " Иногда",
        easyLaundry: " Легко",
        packingLight: " Налегке",
        packingBalanced: " Баланс",
        packingPrepared: " С запасом",
        activitySwimming: " Вода",
        activityHiking: " Хайкинг",
        activityWorkout: " Тренировки",
        activityFormalEvents: " Нарядно",
        activityPhotoContent: " Контент",
        ...
        flightClassLabel: "Класс",
        flightPricePerPassenger: "за 1 пассажира",
        ...
        hotelsSummary: "Под рукой, когда понадобится",
        hotelRoomsLabel: "Номеров",
        hotelRoomsNote: "Для Booking",
        hotelUnitsLabel: "Номеров / апартаментов",
        hotelFiltersTitle: "Настройки поиска",
        hotelRatingLabel: "Рейтинг",
        hotelPriceLabel: "Цена за ночь",
        hotelBedroomsLabel: "Спальни",
        hotelAnyOption: "Любой",
        hotelFromOption: "От",
        hotelPriceFromPlaceholder: "От",
        hotelPriceToPlaceholder: "До",
    ...
    en: {
        ...
        outdoorAdventure: " Adventure",
        beachEscape: " Beach",
        winterTrip: " Winter",
        familyTrip: " Family",
        romanticGetaway: " Romantic",
        activitiesLabel: "Trip focus:",
        accommodationLabel: "Stay:",
        laundryLabel: "Laundry:",
        packingStyleLabel: "Packing mode:",
        tripNoteLabel: "Extra context:",
        tripNotePlaceholder: "For example: mountain trip, one nice dinner, and I want to stay carry-on only",
        hotel: " Hotel",
        apartment: " Apartment",
        hostel: " Hostel",
        camping: " Camping",
        ...
        easyLaundry: " Easy",
        packingLight: " Light",
        packingBalanced: " Balanced",
        packingPrepared: " Prepared",
        activitySwimming: " Water",
        activityHiking: " Hiking",
        activityWorkout: " Workout",
        activityFormalEvents: " Dressy",
        activityPhotoContent: " Content",
        ...
        flightPricePerPassenger: "per passenger",
        ...
        hotelsSummary: "Ready when you need it",
        hotelRoomsLabel: "Rooms",
        hotelRoomsNote: "For Booking",
        hotelUnitsLabel: "Rooms / apartments",
        hotelFiltersTitle: "Search settings",
        hotelRatingLabel: "Rating",
        hotelPriceLabel: "Price per night",
        hotelBedroomsLabel: "Bedrooms",
        hotelAnyOption: "Any",
        hotelFromOption: "From",
        hotelPriceFromPlaceholder: "Min",
        hotelPriceToPlaceholder: "Max",
